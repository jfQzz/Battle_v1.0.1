...
/**
 * 说明：主要功能有清除内/外缓存，清除数据库，清除sharedPreference，清除files和清除自定义目录
 */
public class DataCleanManager {
    ...
    public static void cleanExternalCache(Context context) {
        if (Environment.getExternalStorageState().equals(
                Environment.MEDIA_MOUNTED)) {  //判断有无外部存储卡
    ...
    /**
     * 删除指定目录下文件及目录-----删除指定文件,主要用这个
     *
     * @param deleteThisPath 如果要删除文件，必须是true
     * @return
     */
