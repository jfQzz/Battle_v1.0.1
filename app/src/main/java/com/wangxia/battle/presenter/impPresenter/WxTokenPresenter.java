...
import com.wangxia.battle.model.model.WxTokenModel;
 ...
 *
 */
public class WxTokenPresenter implements IPresenter,ICallback {
    private WxTokenModel wxTokenModel = new WxTokenModel();
    private ISuccessCallbackData iAppInfo;

    public WxTokenPresenter(ISuccessCallbackData iAppInfo) {
        this.iAppInfo = iAppInfo;
    }

    public void queryList(int id ,String args,int pageNo){
        wxTokenModel.queryList(id,args,pageNo, this);
    }
